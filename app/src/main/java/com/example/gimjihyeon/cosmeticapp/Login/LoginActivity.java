...
import com.example.gimjihyeon.protectmycosmetic.db.UserDBManager;
...
/**
 * Created by gimjihyeon on 2017. 9. 28..
 */
...
public class LoginActivity extends BaseActivity {
  /*  Button login_BtnLogin;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Drawable alpha = (findViewById(R.id.login_backgroundImg)).getBackground();
        alpha.setAlpha(50);


        login_BtnRegister = (Button) findViewById(R.id.login_Btn_Register);
        ...
        login_BtnLogin = (Button) findViewById(R.id.login_Btn_Login);
  ...
  SessionCallback callback;
    ...
    private int userBoardCnt=0;
    private int userCosCnt=0;
        ...
        public void onSessionOpened() {
            ...
            UserManagement.requestMe(new MeResponseCallback() {
                ...
                public void onSuccess(UserProfile userProfile) {
                    ...
                    dbManager.UserDBManager(userID,userName,"",userBoardCnt,userCosCnt,0,"","");
